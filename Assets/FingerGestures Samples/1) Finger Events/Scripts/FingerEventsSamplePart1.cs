    ...
    void OnFingerStationary( FingerMotionEvent e )
    {
        ...
        else if( e.Phase == FingerMotionPhase.Updated )
        {
            ...
            if( e.Selection == fingerStationaryObject )
            {
              ...
              //  stationaryParticleEmitter.emission = emissionRate;
...
- Move your finger over and out of the cyan OnFingerHover sphere";
    ...
    ParticleSystem stationaryParticleEmitter;
    ...
    void StopStationaryParticleEmitter()
    {
        ...
        stationaryParticleEmitter.Stop();
        UI.StatusText = "";
    }
    ...
    {
        ParticleSystem emitter = obj.GetComponentInChildren<ParticleSystem>();
       // if( emitter )
         //   emitter.start();
    }
